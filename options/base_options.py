...
class BaseOptions():
	...
	def initialize(self):
		self.parser.add_argument('--dataroot',  type=str,
								 default='/media/disk2/daic/blur_data/3_14GAN/GAN_for_coco_high/A_B',
								 #'/media/disk2/daic/blur_data/3_14GAN/GAN_GO_PRO/A_B',
								 #/media/disk2/daic/blur_data/3_14GAN/GAN_for_coco_high/A_B/test
								 #/media/disk2/daic/blur_data/3_14GAN/GAN_GO_PRO/A_B
								 help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')

		self.parser.add_argument('--tree_label_path',type=str, default='/home/daic/DeblurGANtree/treeNode.json')

		self.parser.add_argument('--att_path', type=str, default='/media/disk2/daic/blur_data/high_blurcoco_resnet_att',
								 help='input batch size')
		self.parser.add_argument('--batchSize', type=int, default=12,
								 help='input batch size')
		self.parser.add_argument('--loadSizeX', type=int, default=256,#600
								 help='scale images to this size')
		self.parser.add_argument('--loadSizeY', type=int, default=256,#600
								 help='scale images to this size')
		self.parser.add_argument('--fineSize', type=int, default=256,#512
		...
		self.parser.add_argument('--gpu_ids', type=str, default='0',			# TODO GPU HERE
								 help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')

		self.parser.add_argument('--name', type=str, default='1114_tree_high',	# TODO NAME HERE
		...
		self.parser.add_argument('--which_direction', type=str, default='BtoA',
								 help='AtoB or BtoA')
